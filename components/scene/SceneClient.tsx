  ...
  return (
    <main className="min-h-screen flex flex-col max-w-2xl mx-auto bg-paper border-x-2 border-ink/15">
      ...
      <div className="px-4 -mt-1 pt-3">
        ...
        {attest && (
          <p className="label-mono mt-1.5 flex items-center gap-1.5" title={`Replies generated by ${attest.model}`}>
            <span
              className={attest.live ? "text-pine" : "text-ink/40"}
              style={attest.live ? { animation: "none" } : undefined}
              aria-hidden
            >
              ⬡
            </span>
