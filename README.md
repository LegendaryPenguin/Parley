...
▶️ **Demo:** a recorded playthrough (Atlas → live conversation → reward → verified record → on-chain activity panel) is at [`docs/demo.webm`](docs/demo.webm). 60-second narrated script in [DEMO.md](DEMO.md).
